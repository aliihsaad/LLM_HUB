...
export declare const PLATFORM_ORDER: readonly ["google", "groq", "cerebras", "sambanova", "nvidia", "mistral", "openrouter", "github", "cohere", "cloudflare", "huggingface", "vercel", "modelscope", "qwen", "siliconflow", "ovhcloud", "zhipu", "ollama", "kilo", "pollinations", "llm7", "bazaarlink"];
